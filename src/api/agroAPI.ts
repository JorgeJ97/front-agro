import { BASE_PATH_API_AGRO } from '@/config';
...
export const agroAPI: AxiosInstance = axios.create({
  baseURL: BASE_PATH_API_AGRO,
  headers: {
...
agroAPI.interceptors.request.use(
...
export const pathsAgro: PathsAgro = {
  users: '/users',
  crops: '/crops',
  clients: '/clients',
  employees: '/employees',
